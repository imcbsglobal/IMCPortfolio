...
const handleView = (photos) => {
  ...
  return (
    <>
    <Helmet>
        <title>ERP Softwares | Softwares | Quality Web Development |</title>
    ...
    <div className='md:ml-[300px] lg:ml-[450px] mt-5 p-5'>
        <section className='Mlg:max-w-[1200px] Mlg:mx-auto mt-16 md:mt-0'>
            <div>
                <div className='FontStyle-Top text-3xl md:text-[52px] text-[#363636] mb-5 leading-normal text-center'>ERP Softwares</div>
            </div>
