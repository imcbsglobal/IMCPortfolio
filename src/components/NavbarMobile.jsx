  ...
  return (
    ...
    <div>
        <div className='w-[130px] h-auto mb-5 flex justify-center mx-auto'>
            <a href="">
                <img src={logo} className='w-full h-full object-contain cursor-pointer' alt="" />
            </a>
        </div>
        <div className='text-center text-3xl font-semibold mb-5'>IMC Business Solutions</div>
        <div className='flex justify-center items-center gap-10 mb-5 bg-white p-5 rounded-full BoxShadow'>
            ...
            <a href="https://www.linkedin.com/in/imc-business-solutions-0b0066335/">
                <div className='text-xl '><FaLinkedinIn /></div>
            </a>
            <a href="https://x.com/imcbsblobal">
                <div className='text-xl '><FaXTwitter /></div>
            </a>
        </div>
    </div>
{/* ) : ( */}
                ...
                <ul className='flex flex-col gap-5 font-semibold'>
                    ...
                    <li>
                        <Link to='/software' onClick={() => setMenuBar(false)}>
                            <div className=' flex justify-center items-center gap-5'>
                                <div className=' text-[#ff9100]'><HiDesktopComputer/></div>
                    ...
                    <li>
                        <Link to='/hardware' onClick={() => setMenuBar(false)}>
                            <div className=' flex justify-center items-center gap-5'>
                                <div className=' text-[#ff9100]'><IoHardwareChip/></div>
                                <div>Hardwares</div>
                            </div>
                        </Link>
                    </li>
                    <li>
                        <Link to='/webapplication' onClick={() => setMenuBar(false)}>
                            <div className=' flex justify-center items-center gap-5'>
                                <div className=' text-[#ff9100]'><IoGlobeOutline/></div>
                    ...
                    <li>
                        <div className='flex flex-col'>
                            ...
                            >
                                ...
                                <li className='mt-2'>
                                    <Link to='/smsWhatsappMarketing' onClick={() => setMenuBar(false)}>
                                        <div className=' flex justify-start items-center gap-5'>
                                            <div className=' text-[#ff9100]'><FaCommentSms/></div>
